export default {
  ...
  featuresSection: {
    ...
    tabs: {
      collection: 'Multi-Source Content Collection',
      analysis: 'Intelligent Analysis & Q&A',
      organization: 'Knowledge System Construction'
    },
    collection: {
      ...
      tags: ['Document Import', 'Web Collection', 'Note Sync', 'Multi-Format Support']
    },
    analysis: {
      ...
      tags: ['Intelligent Q&A', 'Content Analysis', 'Knowledge Extraction', 'Auto Summary']
    },
    organization: {
      ...
      tags: ['Classification Management', 'Tag System', 'Knowledge Graph', 'Smart Recommendations']
    },
    moreFeatures: {
  ...
  downloadSection: {
    ...
    web: {
      title: 'Web Version',
      description: 'No download required, instant experience',
  ...
  aboutSection: {
    title: 'About Us',
    subtitle: 'Using AI Technology to <span class="text-accent-400">Redefine</span> Knowledge Management & Research Methods',
  ...
  appDownload: {
    ...
    wechatBrowser: {
      ...
      topArrow: 'Tap top-right',
      selectBrowser: 'Select Open in Browser',
      message: 'Please follow the instructions above to open this page in a browser',
      button: 'Got it'
    },
    appIntro: {
