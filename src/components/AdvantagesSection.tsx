          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-dark-900 group">
              ...
              <div className="p-5 sm:p-6 relative z-10">
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 text-center">{t('scenarios.professional.title')}</h4>
                <div className="text-center text-gray-700 dark:text-gray-300 text-sm">{t('scenarios.professional.description')}</div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-dark-900 group">
              ...
              <div className="p-5 sm:p-6 relative z-10">
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 text-center">{t('scenarios.personal.title')}</h4>
                <div className="text-center text-gray-700 dark:text-gray-300 text-sm">{t('scenarios.personal.description')}</div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-dark-900 group sm:col-span-2 lg:col-span-1">
              ...
              <div className="p-5 sm:p-6 relative z-10">
                ...
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3 text-center">{t('scenarios.enterprise.title')}</h4>
                <div className="text-center text-gray-700 dark:text-gray-300 text-sm">{t('scenarios.enterprise.description')}</div>
              </div>
            </div>
          </div>
        </div>
