    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1">
          <h3 class="text-xl font-bold mb-4">扎马科技有限公司</h3>
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-gray-300 hover:text-white">知学易</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">企业解决方案</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">API 接口</a></li>
            <li><a href="#" class="text-gray-300 hover:text-white">下载应用</a></li>
          </ul>
        </div>
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white">使用教程</a></li>
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white">服务条款</a></li>
          </ul>
        </div>
      </div>
