      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="tech-card p-8">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-light-700 dark:text-white">
          ...
          <ul className="space-y-4">
            {[
              ...
              <li
                key={feature.key}
                className="group flex items-start gap-4 rounded-lg p-3 transition-all hover:bg-light-200 dark:hover:bg-dark-700"
              >
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-light-200 text-primary-600 transition-all group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-purple-500 group-hover:to-indigo-600 group-hover:text-white dark:bg-dark-700">
                  <IconComponent className="h-5 w-5" />
                </div>
                <div className="flex-1">
                  <div className="mb-1 text-base font-semibold text-light-700 dark:text-white">
        ...
        {/* 系统架构 */}
        <div className="tech-card p-8 flex flex-col">
          <div className="mb-6 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            {/* Bottom Services */}
            <div className="mt-8 pt-8 border-t border-light-300 dark:border-dark-600 flex justify-center gap-12">
              {[
                ...
                return (
                  <div key={index} className="flex flex-col items-center gap-3 group cursor-pointer transition-transform hover:-translate-y-1">
                    <div className="w-20 h-20 rounded-lg border-2 border-light-300 bg-white flex items-center justify-center text-primary-600 shadow-sm transition-all group-hover:bg-gradient-to-br group-hover:from-primary-500 group-hover:to-purple-600 group-hover:text-white group-hover:border-primary-600 group-hover:shadow-md group-hover:scale-110 dark:border-dark-600 dark:bg-dark-800">
                      <ServiceIcon className="h-8 w-8" />
                    </div>
                    <span className="text-sm font-semibold text-light-700 dark:text-white">{service.label}</span>
                  </div>
                );
              })}
            </div>
