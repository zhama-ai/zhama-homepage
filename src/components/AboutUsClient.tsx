      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="animate-fadeIn">
            <h2 className="text-accent-400 font-semibold text-lg uppercase tracking-wider mb-3">{data.title}</h2>
            <p className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl leading-tight" dangerouslySetInnerHTML={{ __html: data.subtitle }}>
            </p>
          ...
          <div className="animate-slideInUp">
            ...
            <div className="space-y-6">
              {data.vision.paragraphs.map((paragraph, index) => (
                <p key={index} className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg" dangerouslySetInnerHTML={{ __html: paragraph }}>
                </p>
              ))}
            </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-2xl text-gray-700 dark:text-gray-300 mx-auto font-light leading-relaxed">
            <span className="text-accent-400 font-bold">{data.footer.prefix}</span>{data.footer.suffix}
